...
1. **Oil Market News** – Search the web for the latest oil market news today. Summarize the top developments (prices, geopolitical events, supply/demand changes, OPEC updates, etc.).

2. **Technical Sentiment (Investing.com)** – Search for Crude Oil WTI technical analysis and sentiment from Investing.com. Report the signals across timeframes (1min, 5min, 15min, 30min, hourly, daily, weekly, monthly) — whether they show Strong Buy, Buy, Neutral, Sell, or Strong Sell. Include key indicator readings (RSI, MACD, Moving Averages) if available.
